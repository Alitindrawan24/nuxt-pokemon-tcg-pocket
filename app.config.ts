  ...
  ui: {
    table: {
      slots: {
        ...
        tbody: 'divide-y divide-default [&>tr]:data-[selectable=true]:hover:bg-elevated/50 [&>tr]:data-[selectable=true]:focus-visible:outline-secondary ',
        tr: 'data-[selected=true]:bg-elevated/50 cursor-pointer hover:[&>td]:text-secondary',
